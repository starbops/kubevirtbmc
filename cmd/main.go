...
import (
	...
	virtualmachinecontroller "kubevirt.io/kubevirtbmc/internal/controller/virtualmachine"
...
func init() {
	...
	utilruntime.Must(virtualmachinev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "511d468c.kubevirt.io",
	...
	if err := (&virtualmachinecontroller.VirtualMachineBMCReconciler{
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := (&virtualmachinev1alpha1.VirtualMachineBMC{}).SetupWebhookWithManager(mgr); err != nil {
