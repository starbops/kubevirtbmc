...
// CoolingLoopCoolant - This type describes coolant.
type CoolingLoopCoolant struct {
...
// AssertCoolingLoopCoolantRequired checks if the required fields are not zero-ed
func AssertCoolingLoopCoolantRequired(obj CoolingLoopCoolant) error {
	return nil
}

// AssertCoolingLoopCoolantConstraints checks if the values respects the defined constraints
func AssertCoolingLoopCoolantConstraints(obj CoolingLoopCoolant) error {
