...
// AssertCircuitCollectionCircuitCollectionRequired checks if the required fields are not zero-ed
func AssertCircuitCollectionCircuitCollectionRequired(obj CircuitCollectionCircuitCollection) error {
...
// AssertCircuitCollectionCircuitCollectionConstraints checks if the values respects the defined constraints
func AssertCircuitCollectionCircuitCollectionConstraints(obj CircuitCollectionCircuitCollection) error {
	for _, el := range obj.Members {
