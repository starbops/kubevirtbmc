...
// AssertStorageCollectionStorageCollectionRequired checks if the required fields are not zero-ed
func AssertStorageCollectionStorageCollectionRequired(obj StorageCollectionStorageCollection) error {
...
// AssertStorageCollectionStorageCollectionConstraints checks if the values respects the defined constraints
func AssertStorageCollectionStorageCollectionConstraints(obj StorageCollectionStorageCollection) error {
	for _, el := range obj.Members {
