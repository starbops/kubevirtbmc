...
// StorageControllerV172Rates - This type describes the various controller rates used for processes such as volume rebuild or consistency checks.
type StorageControllerV172Rates struct {
...
// AssertStorageControllerV172RatesRequired checks if the required fields are not zero-ed
func AssertStorageControllerV172RatesRequired(obj StorageControllerV172Rates) error {
	return nil
}

// AssertStorageControllerV172RatesConstraints checks if the values respects the defined constraints
func AssertStorageControllerV172RatesConstraints(obj StorageControllerV172Rates) error {
