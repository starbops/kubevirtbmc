...
// EthernetInterfaceV1120Dhcpv4Configuration - DHCPv4 configuration for this interface.
type EthernetInterfaceV1120Dhcpv4Configuration struct {

	// An indication of whether DHCP v4 is enabled on this Ethernet interface.
	DHCPEnabled *bool `json:"DHCPEnabled,omitempty"`

	FallbackAddress EthernetInterfaceV1120DhcpFallback `json:"FallbackAddress,omitempty"`
...
// AssertEthernetInterfaceV1120Dhcpv4ConfigurationRequired checks if the required fields are not zero-ed
func AssertEthernetInterfaceV1120Dhcpv4ConfigurationRequired(obj EthernetInterfaceV1120Dhcpv4Configuration) error {
	return nil
}

// AssertEthernetInterfaceV1120Dhcpv4ConfigurationConstraints checks if the values respects the defined constraints
func AssertEthernetInterfaceV1120Dhcpv4ConfigurationConstraints(obj EthernetInterfaceV1120Dhcpv4Configuration) error {
	return nil
}
