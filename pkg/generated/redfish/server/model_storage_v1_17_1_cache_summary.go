...
// StorageV1171CacheSummary - This type describes the cache memory of the storage controller in general detail.
type StorageV1171CacheSummary struct {
...
// AssertStorageV1171CacheSummaryRequired checks if the required fields are not zero-ed
func AssertStorageV1171CacheSummaryRequired(obj StorageV1171CacheSummary) error {
...
// AssertStorageV1171CacheSummaryConstraints checks if the values respects the defined constraints
func AssertStorageV1171CacheSummaryConstraints(obj StorageV1171CacheSummary) error {
