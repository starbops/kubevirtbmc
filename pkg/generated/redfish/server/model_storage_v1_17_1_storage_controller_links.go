...
// StorageV1171StorageControllerLinks - The links to other resources that are related to this resource.
type StorageV1171StorageControllerLinks struct {
...
// AssertStorageV1171StorageControllerLinksRequired checks if the required fields are not zero-ed
func AssertStorageV1171StorageControllerLinksRequired(obj StorageV1171StorageControllerLinks) error {
...
// AssertStorageV1171StorageControllerLinksConstraints checks if the values respects the defined constraints
func AssertStorageV1171StorageControllerLinksConstraints(obj StorageV1171StorageControllerLinks) error {
	for _, el := range obj.Endpoints {
