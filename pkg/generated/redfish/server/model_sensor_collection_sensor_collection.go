...
// AssertSensorCollectionSensorCollectionRequired checks if the required fields are not zero-ed
func AssertSensorCollectionSensorCollectionRequired(obj SensorCollectionSensorCollection) error {
...
// AssertSensorCollectionSensorCollectionConstraints checks if the values respects the defined constraints
func AssertSensorCollectionSensorCollectionConstraints(obj SensorCollectionSensorCollection) error {
	for _, el := range obj.Members {
