...
// ControlControlSingleExcerpt - The `Control` schema describes a control point and its properties.
type ControlControlSingleExcerpt struct {
...
// AssertControlControlSingleExcerptRequired checks if the required fields are not zero-ed
func AssertControlControlSingleExcerptRequired(obj ControlControlSingleExcerpt) error {
	return nil
}

// AssertControlControlSingleExcerptConstraints checks if the values respects the defined constraints
func AssertControlControlSingleExcerptConstraints(obj ControlControlSingleExcerpt) error {
	return nil
}
