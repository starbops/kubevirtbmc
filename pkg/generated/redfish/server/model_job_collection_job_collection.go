...
// AssertJobCollectionJobCollectionRequired checks if the required fields are not zero-ed
func AssertJobCollectionJobCollectionRequired(obj JobCollectionJobCollection) error {
...
// AssertJobCollectionJobCollectionConstraints checks if the values respects the defined constraints
func AssertJobCollectionJobCollectionConstraints(obj JobCollectionJobCollection) error {
	for _, el := range obj.Members {
