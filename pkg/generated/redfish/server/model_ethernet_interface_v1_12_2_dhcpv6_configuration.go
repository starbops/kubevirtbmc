...
type EthernetInterfaceV1122Dhcpv6Configuration struct {
	OperatingMode *EthernetInterfaceV1122Dhcpv6OperatingMode `json:"OperatingMode,omitempty"`
...
// AssertEthernetInterfaceV1122Dhcpv6ConfigurationRequired checks if the required fields are not zero-ed
func AssertEthernetInterfaceV1122Dhcpv6ConfigurationRequired(obj EthernetInterfaceV1122Dhcpv6Configuration) error {
	return nil
}

// AssertEthernetInterfaceV1122Dhcpv6ConfigurationConstraints checks if the values respects the defined constraints
func AssertEthernetInterfaceV1122Dhcpv6ConfigurationConstraints(obj EthernetInterfaceV1122Dhcpv6Configuration) error {
	return nil
}
