...
// BootOptionV105BootOption - The BootOption schema reports information about a single boot option in a system.  It represents the properties of a bootable device available in the system.
type BootOptionV105BootOption struct {
	...
	Actions BootOptionV105Actions `json:"Actions,omitempty"`
...
// AssertBootOptionV105BootOptionRequired checks if the required fields are not zero-ed
func AssertBootOptionV105BootOptionRequired(obj BootOptionV105BootOption) error {
	...
	if err := AssertBootOptionV105ActionsRequired(obj.Actions); err != nil {
		return err
	}
...
// AssertBootOptionV105BootOptionConstraints checks if the values respects the defined constraints
func AssertBootOptionV105BootOptionConstraints(obj BootOptionV105BootOption) error {
	if err := AssertBootOptionV105ActionsConstraints(obj.Actions); err != nil {
		return err
	}
	for _, el := range obj.RelatedItem {
