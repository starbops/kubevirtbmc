...
// StorageV1171Rates - This type describes the various controller rates used for processes such as volume rebuild or consistency checks.
type StorageV1171Rates struct {
...
// AssertStorageV1171RatesRequired checks if the required fields are not zero-ed
func AssertStorageV1171RatesRequired(obj StorageV1171Rates) error {
	return nil
}

// AssertStorageV1171RatesConstraints checks if the values respects the defined constraints
func AssertStorageV1171RatesConstraints(obj StorageV1171Rates) error {
