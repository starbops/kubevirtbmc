...
// AssertResourceV1200LocationRequired checks if the required fields are not zero-ed
func AssertResourceV1200LocationRequired(obj ResourceV1200Location) error {
...
// AssertResourceV1200LocationConstraints checks if the values respects the defined constraints
func AssertResourceV1200LocationConstraints(obj ResourceV1200Location) error {
	for _, el := range obj.Contacts {
