...
type LogEntryV1160LogEntry struct {
	...
	Actions LogEntryV1160Actions `json:"Actions,omitempty"`
	...
	CPER LogEntryV1160Cper `json:"CPER,omitempty"`

	CXLEntryType LogEntryV1160CxlEntryType `json:"CXLEntryType,omitempty"`
	...
	DiagnosticDataType LogEntryV1160LogDiagnosticDataTypes `json:"DiagnosticDataType,omitempty"`

	EntryCode LogEntryV1160LogEntryCode `json:"EntryCode,omitempty"`

	EntryType LogEntryV1160LogEntryType `json:"EntryType"`
	...
	Links LogEntryV1160Links `json:"Links,omitempty"`
	...
	OriginatorType LogEntryV1160OriginatorTypes `json:"OriginatorType,omitempty"`
	...
	SensorType LogEntryV1160SensorType `json:"SensorType,omitempty"`
	...
	Severity LogEntryV1160EventSeverity `json:"Severity,omitempty"`
...
// AssertLogEntryV1160LogEntryRequired checks if the required fields are not zero-ed
func AssertLogEntryV1160LogEntryRequired(obj LogEntryV1160LogEntry) error {
	...
	if err := AssertLogEntryV1160ActionsRequired(obj.Actions); err != nil {
		return err
	}
	if err := AssertLogEntryV1160CperRequired(obj.CPER); err != nil {
		return err
	}
	if err := AssertLogEntryV1160LinksRequired(obj.Links); err != nil {
		return err
	}
...
// AssertLogEntryV1160LogEntryConstraints checks if the values respects the defined constraints
func AssertLogEntryV1160LogEntryConstraints(obj LogEntryV1160LogEntry) error {
	if err := AssertLogEntryV1160ActionsConstraints(obj.Actions); err != nil {
		return err
	}
	if err := AssertLogEntryV1160CperConstraints(obj.CPER); err != nil {
		return err
	}
	if err := AssertLogEntryV1160LinksConstraints(obj.Links); err != nil {
		return err
	}
	for _, el := range obj.ResolutionSteps {
