...
// AssertComputerSystemV1230IdlePowerSaverRequired checks if the required fields are not zero-ed
func AssertComputerSystemV1230IdlePowerSaverRequired(obj ComputerSystemV1230IdlePowerSaver) error {
	return nil
}

// AssertComputerSystemV1230IdlePowerSaverConstraints checks if the values respects the defined constraints
func AssertComputerSystemV1230IdlePowerSaverConstraints(obj ComputerSystemV1230IdlePowerSaver) error {
