...
// AssertOutletCollectionOutletCollectionRequired checks if the required fields are not zero-ed
func AssertOutletCollectionOutletCollectionRequired(obj OutletCollectionOutletCollection) error {
...
// AssertOutletCollectionOutletCollectionConstraints checks if the values respects the defined constraints
func AssertOutletCollectionOutletCollectionConstraints(obj OutletCollectionOutletCollection) error {
	for _, el := range obj.Members {
