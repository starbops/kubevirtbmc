...
// AssertEthernetInterfaceV1122Ipv6AddressPolicyEntryRequired checks if the required fields are not zero-ed
func AssertEthernetInterfaceV1122Ipv6AddressPolicyEntryRequired(obj EthernetInterfaceV1122Ipv6AddressPolicyEntry) error {
	return nil
}

// AssertEthernetInterfaceV1122Ipv6AddressPolicyEntryConstraints checks if the values respects the defined constraints
func AssertEthernetInterfaceV1122Ipv6AddressPolicyEntryConstraints(obj EthernetInterfaceV1122Ipv6AddressPolicyEntry) error {
