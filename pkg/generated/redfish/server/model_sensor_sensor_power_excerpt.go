...
// SensorSensorPowerExcerpt - The `Sensor` schema describes a sensor and its properties.
...
// AssertSensorSensorPowerExcerptRequired checks if the required fields are not zero-ed
func AssertSensorSensorPowerExcerptRequired(obj SensorSensorPowerExcerpt) error {
	return nil
}

// AssertSensorSensorPowerExcerptConstraints checks if the values respects the defined constraints
func AssertSensorSensorPowerExcerptConstraints(obj SensorSensorPowerExcerpt) error {
