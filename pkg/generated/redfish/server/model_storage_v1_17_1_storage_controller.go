...
// StorageV1171StorageController - The StorageController schema describes a storage controller and its properties.  A storage controller represents a physical or virtual storage device that produces volumes.
type StorageV1171StorageController struct {
...
// AssertStorageV1171StorageControllerRequired checks if the required fields are not zero-ed
func AssertStorageV1171StorageControllerRequired(obj StorageV1171StorageController) error {
...
// AssertStorageV1171StorageControllerConstraints checks if the values respects the defined constraints
func AssertStorageV1171StorageControllerConstraints(obj StorageV1171StorageController) error {
