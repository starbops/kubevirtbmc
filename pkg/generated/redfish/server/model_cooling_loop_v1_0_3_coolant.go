...
// CoolingLoopV103Coolant - This type describes coolant.
type CoolingLoopV103Coolant struct {
	...
	CoolantType *CoolingLoopV103CoolantType `json:"CoolantType,omitempty"`
...
// AssertCoolingLoopV103CoolantRequired checks if the required fields are not zero-ed
func AssertCoolingLoopV103CoolantRequired(obj CoolingLoopV103Coolant) error {
	return nil
}

// AssertCoolingLoopV103CoolantConstraints checks if the values respects the defined constraints
func AssertCoolingLoopV103CoolantConstraints(obj CoolingLoopV103Coolant) error {
