...
// AssertIoStatisticsV104IoStatisticsRequired checks if the required fields are not zero-ed
func AssertIoStatisticsV104IoStatisticsRequired(obj IoStatisticsV104IoStatistics) error {
	return nil
}

// AssertIoStatisticsV104IoStatisticsConstraints checks if the values respects the defined constraints
func AssertIoStatisticsV104IoStatisticsConstraints(obj IoStatisticsV104IoStatistics) error {
	return nil
}
