...
// AssertVolumeCollectionVolumeCollectionRequired checks if the required fields are not zero-ed
func AssertVolumeCollectionVolumeCollectionRequired(obj VolumeCollectionVolumeCollection) error {
...
// AssertVolumeCollectionVolumeCollectionConstraints checks if the values respects the defined constraints
func AssertVolumeCollectionVolumeCollectionConstraints(obj VolumeCollectionVolumeCollection) error {
	for _, el := range obj.Members {
