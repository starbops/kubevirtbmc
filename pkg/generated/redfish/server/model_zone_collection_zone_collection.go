...
// AssertZoneCollectionZoneCollectionRequired checks if the required fields are not zero-ed
func AssertZoneCollectionZoneCollectionRequired(obj ZoneCollectionZoneCollection) error {
...
// AssertZoneCollectionZoneCollectionConstraints checks if the values respects the defined constraints
func AssertZoneCollectionZoneCollectionConstraints(obj ZoneCollectionZoneCollection) error {
	for _, el := range obj.Members {
