...
// AssertDriveCollectionDriveCollectionRequired checks if the required fields are not zero-ed
func AssertDriveCollectionDriveCollectionRequired(obj DriveCollectionDriveCollection) error {
...
// AssertDriveCollectionDriveCollectionConstraints checks if the values respects the defined constraints
func AssertDriveCollectionDriveCollectionConstraints(obj DriveCollectionDriveCollection) error {
	for _, el := range obj.Members {
