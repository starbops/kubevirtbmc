...
// AssertComputerSystemV1230LinksRequired checks if the required fields are not zero-ed
func AssertComputerSystemV1230LinksRequired(obj ComputerSystemV1230Links) error {
	...
	if obj.HostingComputerSystem != nil {
...
// AssertComputerSystemV1230LinksConstraints checks if the values respects the defined constraints
func AssertComputerSystemV1230LinksConstraints(obj ComputerSystemV1230Links) error {
	for _, el := range obj.Chassis {
