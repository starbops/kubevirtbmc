...
// ScheduleV125Schedule - Schedule a series of occurrences.
type ScheduleV125Schedule struct {
...
// AssertScheduleV125ScheduleRequired checks if the required fields are not zero-ed
func AssertScheduleV125ScheduleRequired(obj ScheduleV125Schedule) error {
...
// AssertScheduleV125ScheduleConstraints checks if the values respects the defined constraints
func AssertScheduleV125ScheduleConstraints(obj ScheduleV125Schedule) error {
	for _, el := range obj.EnabledDaysOfWeek {
